...
namespace YellowTaxiAP
{
    public static class DebugLocationHelper
    {
        ...
        public static Dictionary<string, string> MoriosLabGroundFloorArcadeGearAlcove = new()
        {
            { "0_01_00027", "Morio's Lab - Gear - Alcove Above Arcade Panik Portal" },
        };
        ...
        [Description("Morio's Lab - Inside Morio's Room")]
        public static Dictionary<string, string> MoriosLabMoriosRoomInside = new()
        {
            { string.Empty, nameof(MoriosLabMoriosRoomInside) + " - !PLACEHOLDER!" }
        };
        ...
        [Description("Morio's Lab - Third Floor Gear Wrench")]
        public static Dictionary<string, string> MoriosLabThirdFloorGearWrench = new()
        {
            { "0_01_00024", "Morio's Lab - Gear - Third Floor Wrenches" },
        };
        ...
        public static Dictionary<string, string> HubSpecialRules = new()
        {
            ...
            { "Granny's Island - Safe on Granny's Statue", "J2 | J1/B1 & X2/GP | X1+B1+J1 | B2 & X1/J1 | X2+GP" },
        ...
        [Description("Bombeach - Distant High Islands")]
        public static Dictionary<string, string> BombeachDistantHighIslands = new()
        {
        ...
        public static Dictionary<string, string> PizzaTimeStartingArea = new()
        {
            ...
            { "2_03_00057", "Pizza Time - Coin on Path Behind Plateau on First Main Island #1" },
            { "2_03_00055", "Pizza Time - Coin on Path Behind Plateau on First Main Island #2" },
            { "2_03_00054", "Pizza Time - Coin on Path Behind Plateau on First Main Island #3" },
            { "2_03_00053", "Pizza Time - Coin on Path Behind Plateau on First Main Island #4" },
            { "2_03_00052", "Pizza Time - Coin on Path Behind Plateau on First Main Island #5" },
            { "2_03_00051", "Pizza Time - Coin on Path Behind Plateau on First Main Island #6" },
            { "2_03_00050", "Pizza Time - Coin on Path Behind Plateau on First Main Island #7" },
            { "2_03_00044", "Pizza Time - Coin on Path Behind Plateau on First Main Island #8" },
            { "2_03_00043", "Pizza Time - Coin on Path Behind Plateau on First Main Island #9" },
            { "2_03_00041", "Pizza Time - Coin on Path Behind Plateau on First Main Island #10" },
            { "2_03_00037", "Pizza Time - Coin on Path Behind Plateau on First Main Island #11" },
            { "2_03_00031", "Pizza Time - Coin on Path Behind Plateau on First Main Island #12" },
        ...
        public static Dictionary<string, string> PizzaTimeAccessibleLedges = new()
        {
            ...
            { "2_03_00421", "Pizza Time - Coin on the Pizza King's Path #8" },
            { "2_03_00420", "Pizza Time - Coin on the Pizza King's Path #9" },
            { "2_03_00419", "Pizza Time - Coin on the Pizza King's Path #10" },
            { "2_03_00418", "Pizza Time - Coin on the Pizza King's Path #11" },
            { "2_03_00417", "Pizza Time - Coin on the Pizza King's Path #12" },
            { "2_03_00487", "Pizza Time - Coin Near Mario's Pizza on the Pizza King's Path #1" },
            { "2_03_00488", "Pizza Time - Coin Near Mario's Pizza on the Pizza King's Path #2" },
            { "2_03_00556", "Pizza Time - Coin Near Mario's Pizza on the Pizza King's Path #3" },
            { "2_03_00558", "Pizza Time - Coin Near Mario's Pizza on the Pizza King's Path #4" },
        ...
        [Description("Pizza Time - Less Accessible Ledges")]
        public static Dictionary<string, string> PizzaTimeLessAccessibleLedges = new()
        {
            { "2_03_00438", "Pizza Time - Coin on Ledge on Fourth Main Island #1" },
            { "2_03_00437", "Pizza Time - Coin on Ledge on Fourth Main Island #2" },
            { "2_03_00436", "Pizza Time - Coin on Ledge on Fourth Main Island #3" },
            { "2_03_00435", "Pizza Time - Coin on Ledge on Fourth Main Island #4" },
            { "2_03_00434", "Pizza Time - Coin on Ledge on Fourth Main Island #5" },
            { "2_03_00426", "Pizza Time - Coin Bag on Ledge on Fourth Main Island #1" },
            { "2_03_00424", "Pizza Time - Coin Bag on Ledge on Fourth Main Island #2" },
            { "2_03_00422", "Pizza Time - Coin on Ledge on Fourth Main Island #6" },
            { "2_03_00423", "Pizza Time - Coin on Ledge on Fourth Main Island #7" },
            { "2_03_00425", "Pizza Time - Coin on Ledge on Fourth Main Island #8" },
            { "2_03_00427", "Pizza Time - Coin on Ledge on Fourth Main Island #9" },
            { "2_03_00298", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #1" },
            { "2_03_00301", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #2" },
            { "2_03_00299", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #3" },
            { "2_03_00295", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #4" },
            { "2_03_00300", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #5" },
            { "2_03_00296", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #6" },
            { "2_03_00293", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #7" },
            { "2_03_00297", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #8" },
            { "2_03_00294", "Pizza Time - Coin on Pizza Island Near Fourth Main Island #9" },
            { "2_03_00166", "Pizza Time - Coin on Cliff Path on Fourth Main Island #1" },
            { "2_03_00167", "Pizza Time - Coin on Cliff Path on Fourth Main Island #2" },
            { "2_03_00168", "Pizza Time - Coin on Cliff Path on Fourth Main Island #3" },
            { "2_03_00169", "Pizza Time - Coin on Cliff Path on Fourth Main Island #4" },
            { "2_03_00170", "Pizza Time - Coin on Cliff Path on Fourth Main Island #5" },
            { "2_03_00287", "Pizza Time - Coin on Cliff Path on Fifth Main Island #1" },
            { "2_03_00288", "Pizza Time - Coin on Cliff Path on Fifth Main Island #2" },
            { "2_03_00289", "Pizza Time - Coin on Cliff Path on Fifth Main Island #3" },
            { "2_03_00290", "Pizza Time - Coin on Cliff Path on Fifth Main Island #4" },
            { "2_03_00291", "Pizza Time - Coin on Cliff Path on Fifth Main Island #5" },
            { "2_03_00331", "Pizza Time - Coin on Cliff on Final Main Island #1" },
            { "2_03_00333", "Pizza Time - Coin on Cliff on Final Main Island #2" },
        };
        ...
        public static Dictionary<string, string> PizzaTimeLedgeLeftOfFinalRoundabout = new()
        {
            ...
            { "2_03_00165", "Pizza Time - Coin on Cliff Path on Final Main Island #1" },
            { "2_03_00164", "Pizza Time - Coin on Cliff Path on Final Main Island #2" },
            { "2_03_00163", "Pizza Time - Coin on Cliff Path on Final Main Island #3" },
            { "2_03_00285", "Pizza Time - Coin on Cliff Path on Final Main Island #4" },
            { "2_03_00284", "Pizza Time - Coin on Cliff Path on Final Main Island #5" },
        ...
        [Description("Pizza Time - High Ground")]
        public static Dictionary<string, string> PizzaTimeHighGround = new()
        {
            { "2_21_00004", "Pizza Time - Cheese on Plateau on First Main Island" },
            { "2_01_00013", "Pizza Time - Gear - Column on Plateau on First Main Island" },
            { "2_03_00124", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #1" },
            { "2_03_00119", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #2" },
            { "2_03_00123", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #3" },
            { "2_03_00118", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #4" },
            { "2_03_00122", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #5" },
            { "2_03_00117", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #6" },
            { "2_03_00121", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #7" },
            { "2_03_00116", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #8" },
            { "2_03_00120", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #9" },
            { "2_03_00115", "Pizza Time - Coin Next to Ramp on Plateau on First Main Island #10" },
            { "2_03_00136", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #1" },
            { "2_03_00132", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #2" },
            { "2_03_00128", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #3" },
            { "2_03_00135", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #4" },
            { "2_03_00127", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #5" },
            { "2_03_00134", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #6" },
            { "2_03_00126", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #7" },
            { "2_03_00133", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #8" },
            { "2_03_00129", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #9" },
            { "2_03_00125", "Pizza Time - Coin Behind Ramp on Plateau on First Main Island #10" },
            { "2_03_00343", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #1" },
            { "2_03_00340", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #2" },
            { "2_03_00346", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #3" },
            { "2_03_00342", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #4" },
            { "2_03_00339", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #5" },
            { "2_03_00348", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #6" },
            { "2_03_00345", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #7" },
            { "2_03_00341", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #8" },
            { "2_03_00347", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #9" },
            { "2_03_00344", "Pizza Time - Coin on Highest Column on Plateau on First Main Island #10" },
            { "2_03_00323", "Pizza Time - Coin on Middle Column on Plateau on First Main Island #1" },
            { "2_03_00326", "Pizza Time - Coin on Middle Column on Plateau on First Main Island #2" },
            { "2_03_00322", "Pizza Time - Coin on Middle Column on Plateau on First Main Island #3" },
            { "2_03_00325", "Pizza Time - Coin on Middle Column on Plateau on First Main Island #4" },
            ...
            { "2_03_00305", "Pizza Time - Coin on House Near Bunny Arch #1" },
            { "2_03_00306", "Pizza Time - Coin on House Near Bunny Arch #2" },
            { "2_03_00329", "Pizza Time - Coin on House Near Bunny Arch #3" },
            { "2_03_00334", "Pizza Time - Coin on House Near Bunny Arch #4" },
            { "2_03_00349", "Pizza Time - Coin Bag on House Near Bunny Arch" },
            { "2_01_00014", "Pizza Time - Gear - On 400° Oven" },
            ...
            { "2_03_00618", "Pizza Time - Chest on 900° Oven" },
            { "2_03_00608", "Pizza Time - Coin on Mario's Pizza #1" },
            { "2_03_00615", "Pizza Time - Coin on Mario's Pizza #2" },
            { "2_03_00490", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #1" },
            { "2_03_00491", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #2" },
            { "2_03_00492", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #3" },
            { "2_03_00501", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #4" },
            { "2_03_00502", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #5" },
            { "2_03_00503", "Pizza Time - Coin Behind Mountain on the Pizza King's Path #6" },
            { "2_03_00309", "Pizza Time - Coin on Island Between First and Third Main Islands #1" },
            { "2_03_00312", "Pizza Time - Coin on Island Between First and Third Main Islands #2" },
            { "2_03_00308", "Pizza Time - Coin on Island Between First and Third Main Islands #3" },
            { "2_03_00311", "Pizza Time - Coin on Island Between First and Third Main Islands #4" },
            { "2_03_00316", "Pizza Time - Coin on Island Between First and Third Main Islands #5" },
            { "2_03_00310", "Pizza Time - Coin on Island Between First and Third Main Islands #6" },
            { "2_03_00315", "Pizza Time - Coin on Island Between First and Third Main Islands #7" },
            { "2_03_00314", "Pizza Time - Coin on Island Between First and Third Main Islands #8" },
            { "2_03_00319", "Pizza Time - Coin on Island Between First and Third Main Islands #9" },
            { "2_03_00313", "Pizza Time - Coin on Island Between First and Third Main Islands #10" },
            { "2_03_00318", "Pizza Time - Coin on Island Between First and Third Main Islands #11" },
            { "2_03_00321", "Pizza Time - Coin on Island Between First and Third Main Islands #12" },
            { "2_03_00317", "Pizza Time - Coin on Island Between First and Third Main Islands #13" },
            { "2_03_00320", "Pizza Time - Coin on Island Between First and Third Main Islands #14" },
            { "2_03_00362", "Pizza Time - Coin on Island Between Second and Final Main Islands #1" },
            { "2_03_00359", "Pizza Time - Coin on Island Between Second and Final Main Islands #2" },
            { "2_03_00363", "Pizza Time - Coin on Island Between Second and Final Main Islands #3" },
            { "2_03_00360", "Pizza Time - Coin on Island Between Second and Final Main Islands #4" },
            { "2_03_00357", "Pizza Time - Coin on Island Between Second and Final Main Islands #5" },
            { "2_03_00361", "Pizza Time - Coin on Island Between Second and Final Main Islands #6" },
            { "2_03_00358", "Pizza Time - Coin on Island Between Second and Final Main Islands #7" },
            { "2_03_00393", "Pizza Time - Coin Bag on Roof Before 600° Oven" },
        };

        [Description("Pizza Time - Second Main Island Mountain Lower")]
        public static Dictionary<string, string> PizzaTimeSecondMainIslandMountainLow = new()
        {
            { "2_03_00330", "Pizza Time - Coin on Morco's Pizza Roof #1" },
            { "2_03_00336", "Pizza Time - Coin on Morco's Pizza Roof #2" },
            { "2_03_00337", "Pizza Time - Coin on Morco's Pizza Roof #3" },
            { "2_03_00338", "Pizza Time - Coin on Morco's Pizza Roof #4" },
            { "2_03_00350", "Pizza Time - Coin on Morco's Pizza Roof #5" },
            { "2_03_00392", "Pizza Time - Coin on Morco's Pizza Roof #6" },
            { "2_03_00412", "Pizza Time - Coin Bag on Morco's Pizza Roof" },
            { "2_02_00001", "Pizza Time - Bunny - Under Arch on Second Main Island" },
            { "2_03_00581", "Pizza Time - Coin on Bunny Arch #1" },
            { "2_03_00582", "Pizza Time - Coin on Bunny Arch #2" },
            { "2_03_00583", "Pizza Time - Coin on Bunny Arch #3" },
            { "2_03_00448", "Pizza Time - Coin on Second Main Island Mountain #1" },
            { "2_03_00453", "Pizza Time - Coin on Second Main Island Mountain #2" },
            { "2_03_00449", "Pizza Time - Coin on Second Main Island Mountain #3" },
            { "2_03_00454", "Pizza Time - Coin on Second Main Island Mountain #4" },
            { "2_03_00450", "Pizza Time - Coin on Second Main Island Mountain #5" },
            { "2_03_00455", "Pizza Time - Coin on Second Main Island Mountain #6" },
            { "2_03_00451", "Pizza Time - Coin on Second Main Island Mountain #7" },
            { "2_03_00456", "Pizza Time - Coin on Second Main Island Mountain #8" },
            { "2_03_00452", "Pizza Time - Coin on Second Main Island Mountain #9" },
            { "2_03_00457", "Pizza Time - Coin on Second Main Island Mountain #10" },
        };

        [Description("Pizza Time - Second Main Island Mountain Upper")]
        public static Dictionary<string, string> PizzaTimeSecondMainIslandMountain = new()
        {
            { "2_03_00609", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #1" },
            { "2_03_00610", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #2" },
            { "2_03_00611", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #3" },
            { "2_03_00612", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #4" },
            { "2_03_00613", "Pizza Time - Coin Bag on Second Main Island Mountain" },
            { "2_03_00614", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #5" },
            { "2_03_00620", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #6" },
            { "2_03_00621", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #7" },
            { "2_03_00622", "Pizza Time - Coin Surrounding Coin Bag on Second Main Island Mountain #8" },
            { "2_03_00627", "Pizza Time - Coin Near Gear on Second Main Island Mountain #1" },
            { "2_03_00632", "Pizza Time - Coin Near Gear on Second Main Island Mountain #2" },
            { "2_03_00637", "Pizza Time - Coin Near Gear on Second Main Island Mountain #3" },
            { "2_03_00640", "Pizza Time - Coin Near Gear on Second Main Island Mountain #4" },
            { "2_03_00624", "Pizza Time - Coin Near Gear on Second Main Island Mountain #5" },
            { "2_03_00628", "Pizza Time - Coin Near Gear on Second Main Island Mountain #6" },
            { "2_03_00633", "Pizza Time - Coin Near Gear on Second Main Island Mountain #7" },
            { "2_03_00638", "Pizza Time - Coin Near Gear on Second Main Island Mountain #8" },
            { "2_03_00641", "Pizza Time - Coin Near Gear on Second Main Island Mountain #9" },
            { "2_03_00625", "Pizza Time - Coin Near Gear on Second Main Island Mountain #10" },
            { "2_03_00629", "Pizza Time - Coin Near Gear on Second Main Island Mountain #11" },
            { "2_03_00634", "Pizza Time - Coin Near Gear on Second Main Island Mountain #12" },
            { "2_03_00639", "Pizza Time - Coin Near Gear on Second Main Island Mountain #13" },
            { "2_03_00626", "Pizza Time - Coin Near Gear on Second Main Island Mountain #14" },
            { "2_01_00000", "Pizza Time - Gear - On Second Main Island Mountain" },
            { "2_03_00635", "Pizza Time - Coin Near Gear on Second Main Island Mountain #15" },
            { "2_03_00631", "Pizza Time - Coin Near Gear on Second Main Island Mountain #16" },
        ...
        public static Dictionary<string, string> PizzaTimeBunnyIslandUpper = new()
        {
            ...
            { "2_03_00476", "Pizza Time - Chest on Bunny Island" },
            { "2_03_00475", "Pizza Time - Coin on Bunny Island #4" },
            { "2_03_00474", "Pizza Time - Coin on Bunny Island #5" },
            { "2_03_00473", "Pizza Time - Coin on Bunny Island #6" },
        };

        [Description("Pizza Time - Floating Orange Island")]
        public static Dictionary<string, string> PizzaTimeFloatingOrangeIsland = new()
        {
            { "2_03_00602", "Pizza Time - Coin on Floating Orange Block Island #1" },
            { "2_03_00605", "Pizza Time - Coin on Floating Orange Block Island #2" },
            { "2_03_00601", "Pizza Time - Coin on Floating Orange Block Island #3" },
            { "2_03_00597", "Pizza Time - Coin on Floating Orange Block Island #4" },
            { "2_03_00606", "Pizza Time - Coin on Floating Orange Block Island #5" },
            { "2_03_00604", "Pizza Time - Coin on Floating Orange Block Island #6" },
            { "2_03_00600", "Pizza Time - Safe on Floating Orange Block Island" },
            { "2_03_00596", "Pizza Time - Coin on Floating Orange Block Island #7" },
            { "2_03_00594", "Pizza Time - Coin on Floating Orange Block Island #8" },
            { "2_03_00603", "Pizza Time - Coin on Floating Orange Block Island #9" },
            { "2_03_00599", "Pizza Time - Coin on Floating Orange Block Island #10" },
            { "2_03_00595", "Pizza Time - Coin on Floating Orange Block Island #11" },
            { "2_03_00598", "Pizza Time - Coin on Floating Orange Block Island #12" },
        };

        [Description("Pizza Time - Spires Near Start")]
        public static Dictionary<string, string> PizzaTimeSpiresNearStart = new()
        {
            { "2_03_00557", "Pizza Time - Coin Bag on Spire Near Start" },
            { "2_03_00408", "Pizza Time - Coin Surrounding Chest on Spire Near Start #1" },
            { "2_03_00407", "Pizza Time - Coin Surrounding Chest on Spire Near Start #2" },
            { "2_03_00409", "Pizza Time - Chest on Spire Near Start" },
            { "2_03_00411", "Pizza Time - Coin Surrounding Chest on Spire Near Start #3" },
            { "2_03_00410", "Pizza Time - Coin Surrounding Chest on Spire Near Start #4" },
            { "2_03_00142", "Pizza Time - Coin Surrounding Safe on Spire Near Start #1" },
            { "2_03_00139", "Pizza Time - Coin Surrounding Safe on Spire Near Start #2" },
            { "2_03_00143", "Pizza Time - Coin Surrounding Safe on Spire Near Start #3" },
            { "2_03_00140", "Pizza Time - Safe on Spire Near Start" },
            { "2_03_00137", "Pizza Time - Coin Surrounding Safe on Spire Near Start #4" },
            { "2_03_00141", "Pizza Time - Coin Surrounding Safe on Spire Near Start #5" },
        ...
        {
            { "2_01_00007", "Pizza Time - Gear - From Pizza King" },
        };
        ...
        public static Dictionary<string, string> ToslaSquareStartingArea = new()
        {
            ...
            { "5_03_00062", "Tosla Square - Coin on Ramp in Alley #1" },
            { "5_03_00061", "Tosla Square - Coin on Ramp in Alley #2" },
            { "5_03_00064", "Tosla Square - Coin on Ramp in Alley #3" },
            { "5_03_00063", "Tosla Square - Coin on Ramp in Alley #4" },
            { "5_03_00066", "Tosla Square - Coin on Ramp in Alley #5" },
            { "5_03_00065", "Tosla Square - Coin on Ramp in Alley #6" },
            { "5_03_00068", "Tosla Square - Coin on Ramp in Alley #7" },
            { "5_03_00067", "Tosla Square - Coin on Ramp in Alley #8" },
        };

        [Description("Tosla Square - Tosla Sign")]
        public static Dictionary<string, string> ToslaSquareToslaSign = new()
        {
            { "5_03_00161", "Tosla Square - Coin on Tosla Sign #1" },
            { "5_03_00162", "Tosla Square - Coin on Tosla Sign #2" },
            { "5_03_00163", "Tosla Square - Coin Bag on Tosla Sign" },
            { "5_03_00164", "Tosla Square - Coin on Tosla Sign #3" },
        ...
        public static Dictionary<string, string> MauriziosCityStartingArea = new()
        {
            ...
            { "9_03_00152", "Maurizio's City - Coin on Left Tree on Lower Middle Level #1" },
            { "9_03_00156", "Maurizio's City - Coin on Left Tree on Lower Middle Level #2" },
            { "9_03_00155", "Maurizio's City - Coin Bag on Left Tree on Lower Middle Level" },
            { "9_03_00154", "Maurizio's City - Coin on Left Tree on Lower Middle Level #3" },
            { "9_03_00160", "Maurizio's City - Coin on Left Tree on Lower Middle Level #4" },
            { "9_03_00153", "Maurizio's City - Coin on Right Tree on Lower Middle Level #1" },
            { "9_03_00159", "Maurizio's City - Coin on Right Tree on Lower Middle Level #2" },
            { "9_03_00158", "Maurizio's City - Coin Bag on Right Tree on Lower Middle Level" },
            { "9_03_00157", "Maurizio's City - Coin on Right Tree on Lower Middle Level #3" },
            { "9_03_00161", "Maurizio's City - Coin on Right Tree on Lower Middle Level #4" },
            { "9_03_00058", "Maurizio's City - Coin on Main Road on Lower Middle Level #1" },
            { "9_03_00059", "Maurizio's City - Coin on Main Road on Lower Middle Level #2" },
            { "9_03_00060", "Maurizio's City - Coin on Main Road on Lower Middle Level #3" },
            { "9_03_00061", "Maurizio's City - Coin on Main Road on Lower Middle Level #4" },
            { "9_03_00062", "Maurizio's City - Coin on Main Road on Lower Middle Level #5" },
            { "9_03_00063", "Maurizio's City - Coin on Main Road on Lower Middle Level #6" },
            { "9_03_00064", "Maurizio's City - Coin on Main Road on Lower Middle Level #7" },
            { "9_03_00104", "Maurizio's City - Coin on House Roof on Lower Middle Level #1" },
            { "9_03_00105", "Maurizio's City - Coin on House Roof on Lower Middle Level #2" },
            { "9_03_00106", "Maurizio's City - Coin on House Roof on Lower Middle Level #3" },
            { "9_03_00108", "Maurizio's City - Coin on House Roof on Lower Middle Level #4" },
            { "9_03_00109", "Maurizio's City - Coin on House Roof on Lower Middle Level #5" },
            { "9_03_00110", "Maurizio's City - Coin on House Roof on Lower Middle Level #6" },
            ...
            { "9_03_00140", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #1" },
            { "9_03_00141", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #2" },
            { "9_03_00142", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #3" },
            { "9_03_00143", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #4" },
            { "9_03_00144", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #5" },
            { "9_03_00145", "Maurizio's City - Coin on Ledge Left of Main Road Ramp Between Middle Levels #6" },
            { "9_03_00146", "Maurizio's City - Chest on Ledge Left of Main Road Ramp Between Middle Levels" },
            { "9_03_00139", "Maurizio's City - Coin on Ledge Right of Main Road Ramp Between Middle Levels #1" },
            { "9_03_00138", "Maurizio's City - Coin on Ledge Right of Main Road Ramp Between Middle Levels #2" },
            { "9_03_00137", "Maurizio's City - Coin on Ledge Right of Main Road Ramp Between Middle Levels #3" },
            { "9_03_00136", "Maurizio's City - Coin on Ledge Right of Main Road Ramp Between Middle Levels #4" },
            { "9_03_00210", "Maurizio's City - Coin on Main Road on Upper Middle Level Before Checkpoint #1" },
            { "9_03_00211", "Maurizio's City - Coin on Main Road on Upper Middle Level Before Checkpoint #2" },
            { "9_03_00212", "Maurizio's City - Coin on Main Road on Upper Middle Level Before Checkpoint #3" },
            { "9_03_00213", "Maurizio's City - Coin on Main Road on Upper Middle Level Before Checkpoint #4" },
            { "9_09_00365", "Maurizio's City - Checkpoint on Upper Middle Level" },
            { "9_03_00232", "Maurizio's City - Coin on Main Road on Upper Middle Level After Checkpoint #1" },
            { "9_03_00231", "Maurizio's City - Coin on Main Road on Upper Middle Level After Checkpoint #2" },
            { "9_03_00230", "Maurizio's City - Coin on Main Road on Upper Middle Level After Checkpoint #3" },
            { "9_03_00229", "Maurizio's City - Coin on Main Road on Upper Middle Level After Checkpoint #4" },
            { "9_03_00228", "Maurizio's City - Coin on Main Road on Upper Middle Level After Checkpoint #5" },
            { "9_21_00008", "Maurizio's City - Cheese in Passageway Under Metavoidal Poster" },
            { "9_21_00007", "Maurizio's City - Cheese in Cheese Shop on Upper Middle Level #1" },
            { "9_21_00004", "Maurizio's City - Cheese in Cheese Shop on Upper Middle Level #2" },
            { "9_03_00199", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #1" },
            { "9_03_00198", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #2" },
            { "9_03_00197", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #3" },
            { "9_03_00151", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #4" },
            { "9_03_00150", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #5" },
            { "9_03_00149", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #6" },
            { "9_03_00148", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #7" },
            { "9_03_00147", "Maurizio's City - Coin on Cliff Off of Upper Middle Level #8" },
            ...
            { "9_21_00001", "Maurizio's City - Cheese Near Doggo on Upper Level" },
        };
        ...
        {
            { "9_03_00113", "Maurizio's City - Coin on Red Beams on Lower Middle Level #5" },
            { "9_03_00101", "Maurizio's City - Coin on Red Beams on Lower Middle Level #6" },
            { "9_03_00114", "Maurizio's City - Coin on Red Beams on Lower Middle Level #7" },
            { "9_03_00102", "Maurizio's City - Coin on Red Beams on Lower Middle Level #8" },
            { "9_03_00115", "Maurizio's City - Coin on Red Beams on Lower Middle Level #9" },
            { "9_03_00103", "Maurizio's City - Coin on Red Beams on Lower Middle Level #10" },
            { "9_03_00095", "Maurizio's City - Coin on Red Beams on Lower Middle Level #11" },
            { "9_03_00097", "Maurizio's City - Coin on Red Beams on Lower Middle Level #12" },
            { "9_03_00098", "Maurizio's City - Coin on Red Beams on Lower Middle Level #13" },
            { "9_03_00100", "Maurizio's City - Coin on Red Beams on Lower Middle Level #14" },
            ...
            { "9_03_00164", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #1" },
            { "9_03_00180", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #2" },
            { "9_03_00165", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #3" },
            { "9_03_00181", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #4" },
            { "9_03_00166", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #5" },
            { "9_03_00182", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #6" },
            { "9_03_00167", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #7" },
            { "9_03_00183", "Maurizio's City - Coin on Alcove Building Above Lowest Level Plaza #8" },
            { "9_03_00201", "Maurizio's City - Coin on Brown Building on Lower Middle Level #1" },
            { "9_03_00202", "Maurizio's City - Coin on Brown Building on Lower Middle Level #2" },
            { "9_03_00203", "Maurizio's City - Coin on Brown Building on Lower Middle Level #3" },
            { "9_03_00206", "Maurizio's City - Coin on Dark Gray Building on Lower Middle Level #1" },
            { "9_03_00207", "Maurizio's City - Coin Bag on Dark Gray Building on Lower Middle Level #1" },
            { "9_03_00208", "Maurizio's City - Coin Bag on Dark Gray Building on Lower Middle Level #2" },
            { "9_03_00209", "Maurizio's City - Coin on Dark Gray Building on Lower Middle Level #2" },
            ...
            { "9_03_00347", "Maurizio's City - Chest in Red Beam Structure Overlooking Cliff on Upper Middle Level" }
        };

        [Description("Maurizio's City - Coin Bags on Roofs Under Maurizio's Building")]
        public static Dictionary<string, string> MauriziosCityRoofsUnderMaurizio = new()
        {
            { "9_03_00301", "Maurizio's City - Coin Bag on Mario's Pizza Roof Near Maurizio's Building" },
            { "9_03_00346", "Maurizio's City - Coin Bag on Hotel Roof Near Maurizio's Building" }
        };

        [Description("Maurizio's City - Trickier High Ground")]
        public static Dictionary<string, string> MauriziosCityTrickierHighGround = new()
        {
            { "9_01_00010", "Maurizio's City - Gear - On Water Tower Near Hat World" },
            { "9_01_00006", "Maurizio's City - Gear - On Maurizio's Statue" },
            { "9_03_00325", "Maurizio's City - Coin Bag on Tree Behind Brown Buildings on Upper Middle Level #1" },
            { "9_03_00344", "Maurizio's City - Coin Bag on Tree Behind Brown Buildings on Upper Middle Level #2" },
            { "9_03_00375", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #1" },
            { "9_03_00374", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #2" },
            { "9_03_00373", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #3" },
            { "9_03_00378", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #4" },
            { "9_03_00376", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #5" },
            { "9_03_00381", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #6" },
            { "9_03_00380", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #7" },
            { "9_03_00379", "Maurizio's City - Coin Between Skylights on Brown Building Near Maurizio's #8" },
            { "9_03_00394", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #1" },
            { "9_03_00393", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #2" },
            { "9_03_00392", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #3" },
            { "9_03_00391", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #4" },
            { "9_03_00390", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #5" },
            { "9_03_00395", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #6" },
            { "9_03_00397", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #7" },
            { "9_03_00399", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #8" },
            { "9_03_00401", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #9" },
            { "9_03_00403", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #10" },
            { "9_03_00405", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #11" },
            { "9_03_00406", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #12" },
            { "9_03_00407", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #13" },
            { "9_03_00408", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #14" },
            { "9_03_00409", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #15" },
            { "9_03_00404", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #16" },
            { "9_03_00402", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #17" },
            { "9_03_00400", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #18" },
            { "9_03_00398", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #19" },
            { "9_03_00396", "Maurizio's City - Coin Surrounding Skylight on Tall Dark Gray Building Near Maurizio's #20" },
            { "9_01_00013", "Maurizio's City - Gear - In Large Red Beam Structure" },
            { "9_03_00443", "Maurizio's City - Coin in Arrow Above Red Beam #1" },
            { "9_03_00441", "Maurizio's City - Coin in Arrow Above Red Beam #2" },
            { "9_03_00410", "Maurizio's City - Coin in Arrow Above Red Beam #3" },
            { "9_03_00411", "Maurizio's City - Coin in Arrow Above Red Beam #4" },
            { "9_03_00412", "Maurizio's City - Coin in Arrow Above Red Beam #5" },
            { "9_03_00388", "Maurizio's City - Coin in Arrow Above Red Beam #6" },
            { "9_03_00389", "Maurizio's City - Coin in Arrow Above Red Beam #7" },
            { "9_03_00386", "Maurizio's City - Coin in Arrow Above Red Beam #8" },
            { "9_03_00414", "Maurizio's City - Coin Bag on Brown Building Near Large Red Beam Structure #1" },
            { "9_03_00413", "Maurizio's City - Coin Bag on Brown Building Near Large Red Beam Structure #2" },
            { "9_01_00015", "Maurizio's City - Gear - On Brown Building Near Large Red Beam Structure" },
            { "9_03_00452", "Maurizio's City - Coin on Top of Large Red Beam Structure #1" },
            { "9_03_00453", "Maurizio's City - Coin on Top of Large Red Beam Structure #2" },
            { "9_03_00454", "Maurizio's City - Coin on Top of Large Red Beam Structure #3" },
            { "9_03_00455", "Maurizio's City - Coin on Top of Large Red Beam Structure #4" },
        };

        [Description("Maurizio's City - Maurizio's Building Lower Ledge")]
        public static Dictionary<string, string> MauriziosCityMaurizioBuildingLower = new()
        {
            { "9_09_00390", "Maurizio's City - Checkpoint on Maurizio's Building Lower Ledge" },
            { "9_03_00420", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #1" },
            { "9_03_00421", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #2" },
            { "9_03_00422", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #3" },
            { "9_03_00423", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #4" },
            { "9_03_00425", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #5" },
            { "9_03_00426", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #6" },
            { "9_03_00427", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #7" },
            { "9_03_00428", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #8" },
            { "9_03_00429", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #9" },
            { "9_03_00430", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #10" },
            { "9_03_00431", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #11" },
            { "9_03_00432", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #12" },
            { "9_03_00433", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #13" },
            { "9_03_00434", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #14" },
            { "9_03_00435", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #15" },
            { "9_03_00436", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #16" },
            { "9_03_00437", "Maurizio's City - Coin on Maurizio's Building Lower Ledge #17" },
        };

        [Description("Maurizio's City - Maurizio's Building Maurizio Area")]
        public static Dictionary<string, string> MauriziosCityMaurizioBuildingMiddle = new()
        {
            { "9_01_00004", "Maurizio's City - Gear - Help Maurizio" },
        };

        [Description("Maurizio's City - Maurizio's Building Upper Area")]
        public static Dictionary<string, string> MauriziosCityMaurizioBuildingUpper = new()
        {
            { "9_02_00002", "Maurizio's City - Bunny - On Top of Maurizio's Building" },
            { "9_07_00024", "Purchase Captain Abs-urd Hat" },
            { "9_07_00025", "Purchase Roid-Man Hat" },
        };

        [Description("Maurizio's City - Island Near Hat World")]
        public static Dictionary<string, string> MauriziosCityIslandNearHatWorld = new()
        {
            { "9_03_00077", "Maurizio's City - Coin on Tall Island Near Hat World #1" },
            { "9_03_00084", "Maurizio's City - Coin on Tall Island Near Hat World #2" },
            { "9_03_00076", "Maurizio's City - Coin on Tall Island Near Hat World #3" },
            { "9_03_00070", "Maurizio's City - Coin on Tall Island Near Hat World #4" },
            { "9_03_00083", "Maurizio's City - Coin on Tall Island Near Hat World #5" },
            { "9_03_00075", "Maurizio's City - Coin on Tall Island Near Hat World #6" },
            { "9_03_00069", "Maurizio's City - Coin on Tall Island Near Hat World #7" },
            { "9_03_00082", "Maurizio's City - Coin on Tall Island Near Hat World #8" },
            { "9_03_00074", "Maurizio's City - Coin on Tall Island Near Hat World #9" },
            { "9_03_00068", "Maurizio's City - Coin on Tall Island Near Hat World #10" },
            { "9_03_00081", "Maurizio's City - Coin on Tall Island Near Hat World #11" },
            { "9_03_00067", "Maurizio's City - Coin on Tall Island Near Hat World #12" },
            { "9_03_00091", "Maurizio's City - Coin on Tall Island Near Hat World #13" },
            { "9_03_00089", "Maurizio's City - Coin on Tall Island Near Hat World #14" },
            { "9_01_00018", "Maurizio's City - Gear - On Tall Island Near Hat World" },
            { "9_03_00072", "Maurizio's City - Coin on Tall Island Near Hat World #15" },
            { "9_03_00066", "Maurizio's City - Coin on Tall Island Near Hat World #16" },
            { "9_03_00079", "Maurizio's City - Coin on Tall Island Near Hat World #17" },
            { "9_03_00078", "Maurizio's City - Coin on Tall Island Near Hat World #18" },
        };
        ...
        [Description("Maurizio's City - Lower Plaza Central Building")]
        public static Dictionary<string, string> MauriziosCityLowerPlazaCenterBuilding = new()
        {
            { "9_03_00275", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #1" },
            { "9_03_00276", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #2" },
            { "9_03_00277", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #3" },
            { "9_03_00272", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #4" },
            { "9_03_00274", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #5" },
            { "9_03_00267", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #6" },
            { "9_03_00268", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #7" },
            { "9_01_00011", "Maurizio's City - Gear - On Central Building in Lowest Level Plaza" },
            { "9_03_00270", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #8" },
            { "9_03_00271", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #9" },
            { "9_03_00264", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #10" },
            { "9_03_00266", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #11" },
            { "9_03_00261", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #12" },
            { "9_03_00262", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #13" },
            { "9_03_00263", "Maurizio's City - Coin on Central Building in Lowest Level Plaza #14" },
        };
        ...
        public static Dictionary<string, string> MauriziosCityFloatingOrangeBlockCloserCoins = new()
        {
            { "9_03_00367", "Maurizio's City - Coin on Floating Orange Blocks #1" },
            { "9_03_00368", "Maurizio's City - Coin on Floating Orange Blocks #2" },
            { "9_03_00369", "Maurizio's City - Coin on Floating Orange Blocks #3" },
            { "9_03_00364", "Maurizio's City - Coin on Floating Orange Blocks #4" },
            { "9_03_00366", "Maurizio's City - Coin on Floating Orange Blocks #5" },
        };

        [Description("Maurizio's City - Floating Orange Blocks With Coins (Further Coins)")]
        public static Dictionary<string, string> MauriziosCityFloatingOrangeBlockCoins = new()
        {
            { "9_03_00365", "Maurizio's City - Chest on Floating Orange Blocks" },
            { "9_03_00361", "Maurizio's City - Coin on Floating Orange Blocks #6" },
            { "9_03_00362", "Maurizio's City - Coin on Floating Orange Blocks #7" },
            { "9_03_00363", "Maurizio's City - Coin on Floating Orange Blocks #8" },
        };

        [Description("Maurizio's City - Floating Orange Blocks With Bunny")]
        public static Dictionary<string, string> MauriziosCityFloatingOrangeBlockBunny = new()
        {
            { "9_02_00000", "Maurizio's City - Bunny - On Orange Blocks" }
        };
        ...
        [
            ...
            new(GetDescription(nameof(MoriosLabMoriosRoomInside)), MoriosLabMoriosRoomInside),
            ...
            new(GetDescription(nameof(PizzaTimeSecondMainIslandMountainLow)), PizzaTimeSecondMainIslandMountainLow),
            ...
            new(GetDescription(nameof(MauriziosCityRoofsUnderMaurizio)), MauriziosCityRoofsUnderMaurizio),
            new(GetDescription(nameof(MauriziosCityTrickierHighGround)), MauriziosCityTrickierHighGround),
            new(GetDescription(nameof(MauriziosCityMaurizioBuildingLower)), MauriziosCityMaurizioBuildingLower),
            new(GetDescription(nameof(MauriziosCityMaurizioBuildingMiddle)), MauriziosCityMaurizioBuildingMiddle),
            new(GetDescription(nameof(MauriziosCityMaurizioBuildingUpper)), MauriziosCityMaurizioBuildingUpper),
            new(GetDescription(nameof(MauriziosCityIslandNearHatWorld)), MauriziosCityIslandNearHatWorld),
            ...
            new(GetDescription(nameof(MauriziosCityLowerPlazaCenterBuilding)), MauriziosCityLowerPlazaCenterBuilding),
            new(GetDescription(nameof(MauriziosCityOrangeBlocksOnRedBeams)), MauriziosCityOrangeBlocksOnRedBeams),
            new(GetDescription(nameof(MauriziosCityFloatingOrangeBlockCloserCoins)), MauriziosCityFloatingOrangeBlockCloserCoins),
            new(GetDescription(nameof(MauriziosCityFloatingOrangeBlockCoins)), MauriziosCityFloatingOrangeBlockCoins),
            new(GetDescription(nameof(MauriziosCityFloatingOrangeBlockBunny)), MauriziosCityFloatingOrangeBlockBunny),
        ...
        public static Dictionary<string, List<Dictionary<string, string>>> PerLevelIDs = new()
        {
            ...
            },
            {
                ...
                [
                    ...
                    PizzaTimeHighGround,
                    PizzaTimeSecondMainIslandMountainLow,
            ...
            },
            {
                ...
                [
                    ...
                    MauriziosCityRoofsUnderMaurizio,
                    MauriziosCityTrickierHighGround,
                    MauriziosCityMaurizioBuildingLower,
                    MauriziosCityMaurizioBuildingMiddle,
                    MauriziosCityMaurizioBuildingUpper,
                    MauriziosCityIslandNearHatWorld,
                    MauriziosCityExpert2RoofsUnderCheckpointBuilding,
                    MauriziosCityCheckpointBuildingOnUpperLevel,
                    MauriziosCityLowerPlazaCenterBuilding,
                    MauriziosCityOrangeBlocksOnRedBeams,
                    MauriziosCityFloatingOrangeBlockCloserCoins,
                    MauriziosCityFloatingOrangeBlockCoins,
                    MauriziosCityFloatingOrangeBlockBunny,
        ...
        public static Dictionary<string, List<RegionConnection>> RegionConnections = new()
        {
            ...
            // Granny's Island
            {
                ...
                [
                    ...
                    new RegionConnection(GrannysIslandMoat, "X2/OGI/J1/B1"),
                ]
            },
            {
                ...
                [
                    ...
                    new RegionConnection(GrannysIslandStart, "X1/OGI/J1/B1"),
            ...
            {
                GetDescription(nameof(MoriosLabMiddleFloorsGoldenPropeller)),
                [
            ...
            {
                GetDescription(nameof(BombeachBunnyPillar)),
                [
                    // Doesn't connect anywhere
                ]
            },
...

            {
                ...
                [
                    ...
                    new RegionConnection(PizzaTimeSecondMainIslandMountainLow, "X3/J1/B1"),
            ...
            {
                GetDescription(nameof(PizzaTimeLessAccessibleLedges)),
                [
                    // No connections
                ]
            },
            ...
            {
                GetDescription(nameof(PizzaTimeSecondMainIslandMountainLow)),
                [
            ...
            {
                GetDescription(nameof(PizzaTimePizzaKing)),
                [
                    // No connections
                ]
            },
...

            {
                ...
                [
                    ...
                    new RegionConnection(MauriziosCityLowerHighGround, "J1/B1"),
                    new RegionConnection(MauriziosCityTrickierHighGround, "J1 & X1/B1 | X1+B1 | J2"),
                    new RegionConnection(MauriziosCityRoofsUnderMaurizio, "J1"),
                    new RegionConnection(MauriziosCityIslandNearHatWorld, "J2 | X1/B2 & J1 | X1+B1"),
                    ...
                    new RegionConnection(MauriziosCityOrangeBlocksOnRedBeams, "J2 | X1 & J1/B2 | X1+B1 & X2/OS"),
            ...
            },
            {
                ...
                [
                    new RegionConnection(MauriziosCityLowerPlazaCenterBuilding, "B1 | X1+J2"),
                ]
            },
            {
            ...
            {
                GetDescription(nameof(MauriziosCityMaurizioBuildingLower)),
                [
                    new RegionConnection(MauriziosCityRoofsUnderMaurizio),
                    new RegionConnection(MauriziosCityMaurizioBuildingMiddle, "B1 | X3+J1"),
                ]
            },
            {
            ...
            {
                GetDescription(nameof(MauriziosCityIslandNearHatWorld)),
                [
                    // No connections
                ]
            },
            ...
            {
                GetDescription(nameof(MauriziosCityLowerPlazaCenterBuilding)),
                [
                    // No connections
                ]
            },
            {
                GetDescription(nameof(MauriziosCityFloatingOrangeBlockCloserCoins)),
                [
                    new RegionConnection(MauriziosCityFloatingOrangeBlockCoins, "OS")
                ]
            },
            {
                GetDescription(nameof(MauriziosCityFloatingOrangeBlockCoins)),
                [
                    new RegionConnection(MauriziosCityFloatingOrangeBlockCloserCoins),
                    new RegionConnection(MauriziosCityFloatingOrangeBlockBunny, "OS+J1+B2 | X1+OS+J1 & X2/B1"),
                    new RegionConnection(MauriziosCityLowerPlazaCenterBuilding, "OS & B1/J1"),
                ]
            },
            {
                GetDescription(nameof(MauriziosCityFloatingOrangeBlockBunny)),
                [
                    new RegionConnection(MauriziosCityLowerPlazaCenterBuilding)
                ]
            },
            {
            ...
            if (DebugLocationHelper.Enabled)
            {
                ...
                if (DebugLocationHelper.PerLevelIDs.ContainsKey(GameplayMaster.instance.levelId.ToString()))
                {
                                 ...
                                 GameplayMaster.instance.levelId.ToString()])
                    {
                        ...
                        json = json.TrimEnd(',');
                        json += "\n  },";
                        foreach (var item in regionItems.Where(o => !o.Value.StartsWith($"{sublevelname} - ") && !regionHats.Contains(o)))
                        {
                            Plugin.Log($"WARNING: \"{item.Value}\" DOES NOT PROPERLY FOLLOW NAMING GUIDELINES");
                        }
                    }
                    json = json.TrimEnd(',');
