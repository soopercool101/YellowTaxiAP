...
public class WarpIdentifier
{
    ...
    public static List<WarpIdentifier> KnownWarps = new()
    {
        ...
        new WarpIdentifier("Granny's Island - Gym Gears Entrance", "Gym Gears - Granny's Island Portal", "", LevelId.Hub, Levels.Index.level_Gym, LevelId.L6_Gym, new Vector3(319.4f, 15f, 101.27f), new Vector3(5f, 0f, 0.1f), 0, 0, false, true, "SoundtrackGym", "Background Skyline Night"),
        new WarpIdentifier("Granny's Island - Poop House", "Fecal Matters - Granny's Island Portal", "", LevelId.Hub, Levels.Index.level_PoopWorld, LevelId.L7_PoopWorld, new Vector3(250f, 20f, -95f), new Vector3(0f, 0f, 0f), 0, 0, true, true, "SoundtrackPoopWorld", "Backround Sky Poop World"),
        new WarpIdentifier("Granny's Island - Flushed Away Entrance", "Flushed Away - Granny's Island Portal", "", LevelId.Hub, Levels.Index.level_Sewers, LevelId.L8_Sewers, new Vector3(175f, 10f, -709.92f), new Vector3(20f, 250f, 5f), 0, 0, false, true, "SoundtrackSewers", "Background Black"),
        new WarpIdentifier("Granny's Island - Mosk's Rocket Entrance", "Mosk's Rocket - Exit to Granny's Island", "", LevelId.Hub, Levels.Index.level_Rocket, LevelId.L16_Rocket, new Vector3(190f, 45f, -58.73f), new Vector3(-1140f, 0f, -1120f), 0, 0, true, true, "SoundtrackRocket", "Background Bonus Level"),
        ...
        new WarpIdentifier("Morio's Lab - Morio's Home Portal", "" /*Only exit is in different subarea. Consider a one-way?*/, "", LevelId.Hub, Levels.Index.level_MoriosHome, LevelId.L3_MoriosHome, new Vector3(-640f, 30f, 730f), new Vector3(0f, 10f, 960f), 0, 0, true, true, "SoundtrackMoriosHome", "Background Morio's Island"),
        new WarpIdentifier("Morio's Lab - Bombeach Portal", "Bombeach - Morio's Lab Portal", "", LevelId.Hub, Levels.Index.level_bombeach, LevelId.L1_Bombeach, new Vector3(-640f, 50f, 630f), new Vector3(0f, 0f, 800f), 0, 0, true, true, "SoundtrackBombeach", "Background Bombeach"),
        new WarpIdentifier("Morio's Lab - Arcade Panik Portal", "Arcade Panik - Morio's Lab Portal", "", LevelId.Hub, Levels.Index.level_PanikArcade, LevelId.L4_ArcadePanik, new Vector3(-780f, 50f, 680f), new Vector3(-800f, 0f, 0f), 180, 3, true, false, "SoundtrackArcadePanik", "Background Sea and Sky - Sunset"),
        new WarpIdentifier("Morio's Lab - Pizza Time Portal", "Pizza Time - Morio's Lab Portal", "", LevelId.Hub, Levels.Index.level_PizzaTime, LevelId.L2_PizzaTime, new Vector3(-720f, 50f, 810f), new Vector3(0f, 0f, 0f), 180, 0, true, true, "SoundtrackPizzaTime", "Background Pizza Time"),
        ...
        new WarpIdentifier("Morio's Home - Morio's Lab Portal", "Morio's Lab - Morio's Home Portal", "", LevelId.L3_MoriosHome, Levels.Index.level_HubDEMO, LevelId.Hub, new Vector3(83.79849f, 70.41628f, -847.1847f), new Vector3(-650f, 30f, 720f), 135, 2, true, false, "SoundtrackHubInside", "Background Soffitto Laboratorio"),
        // Weird Tunnel Warps
